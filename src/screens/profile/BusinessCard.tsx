import Input from "../../components/ui/Input";
 ...
 export  const BusinessCard: React.FC<companyProps> = ({ isEditing, editedCompany, handleInputChange, data }) => (<div className="p-5 rounded-xl border bg-white shadow-sm hover:shadow-md transition-shadow">
  ...
  <div className="space-y-3">
    <div>
      ...
      {isEditing ? (
        ...
        <Input onChange={(e) => handleInputChange('name', e.target.value)} value={editedCompany?.name || data.name} />
      ) : (
